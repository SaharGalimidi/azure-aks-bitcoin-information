...
def job():
    ...
    if bitcoin_value is not None:
        print(f"Current Bitcoin Value (Service A): {bitcoin_value}")
...
def calculate_average():
    ...
    if bitcoin_values:
        ...
        print(f"Average Bitcoin Value (Service A - last 10 minutes): {average_value}")
        bitcoin_values.clear()  # Reset the list for the next 10 minutes
